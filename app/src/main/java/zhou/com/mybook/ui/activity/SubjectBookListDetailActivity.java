...
import zhou.com.mybook.ui.adapter.SubjectBookListDetailBooksAdapter;
import zhou.com.mybook.ui.contract.SubjectBookListDetailContract;
import zhou.com.mybook.ui.presenter.SubjectBookListDetailPresenter;
...
public class SubjectBookListDetailActivity extends BaseRVActivity<BookListDetail.BookListBean.BooksBean> implements SubjectBookListDetailContract.View  {
    ...
    private SubjectBookListDetailPresenter mPresenter = new SubjectBookListDetailPresenter(this);
    ...
    public void initToolBar() {
        common_toolbar.setTitle(R.string.subject_book_list_detail);
