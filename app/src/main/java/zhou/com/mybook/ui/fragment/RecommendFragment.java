...
import zhou.com.mybook.bean.support.UserSexChooseFinishedEvent;
...
import zhou.com.mybook.ui.presenter.RecommendPresenter;
...
public class RecommendFragment extends BaseRVFragment<RecommendPresenter, Recommend.RecommendBooks> implements RecommendContract.View, RecyclerArrayAdapter.OnItemLongClickListener {
    ...
    public void configViews() {
        ...
        mAdapter.addFooter(new RecyclerArrayAdapter.ItemView() {
            ...
            public void onBindView(View headerView) {
                headerView.setOnClickListener(v -> ((MainActivity) activity).setCurrentItem(2));
            }
        });
        mRecyclerView.getEmptyView().findViewById(R.id.btnToAdd).setOnClickListener(v -> ((MainActivity) activity).setCurrentItem(2));
        onRefresh();
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode==1){
            Log.d("", "onActivityResult: 1111111111111111");
        }else {
            Log.d("", "onActivityResult: 2222222222222222");
        }
    }
