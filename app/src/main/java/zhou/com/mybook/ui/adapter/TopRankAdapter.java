...
public class TopRankAdapter extends BaseExpandableListAdapter {
    ...
    private List<TopRankBean.MaleBean> groupArray;
    private List<List<TopRankBean.MaleBean>> childArray;

    private OnRvItemClickListener<TopRankBean.MaleBean> listener;

    public TopRankAdapter(Context context, List<TopRankBean.MaleBean> groupArray, List<List<TopRankBean.MaleBean>> childArray) {
    ...
    public void setItemClickListener(OnRvItemClickListener<TopRankBean.MaleBean> listener) {
