...
public class TopFeRankAdapter extends BaseExpandableListAdapter {

    private Context mContext;
    private LayoutInflater inflater;

    private List<TopRankBean.FemaleBean> groupArray;
    private List<List<TopRankBean.FemaleBean>> childArray;

    private OnRvItemClickListener<TopRankBean.FemaleBean> listener;

    public TopFeRankAdapter(Context context, List<TopRankBean.FemaleBean> groupArray, List<List<TopRankBean.FemaleBean>> childArray) {
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (!TextUtils.isEmpty(groupArray.get(groupPosition).getCover())) {
            Glide.with(mContext).load(Constant.IMG_BASE_URL + groupArray.get(groupPosition).getCover()).placeholder(R.drawable.avatar_default)
    ...
    public void setItemClickListener(OnRvItemClickListener<TopRankBean.FemaleBean> listener) {
